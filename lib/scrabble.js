...
var points = 0; // déclarer la variable points avec une valeur à 0
var total = 0; // déclarer la variable total avec une valeur à 0
var lettres = {  // crée un tableau des correspondances lettres/points
    a: 1,
    b: 3,
    c: 3,
    d: 2,
...
for (i = 0; i < word.length; i++) { // crée une boucle pour chaque lettre contenue dans l'argument
    points = mot[i]; //nombre de points pour une lettre
    total += lettres[points]; //nombre de points pour le mot
}
